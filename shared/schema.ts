...
// Fishfire Business Management Tables

// Products (for stock management)
export const fishfireProducts = pgTable("fishfire_products", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  name: text("name").notNull(),
  description: text("description"),
  sku: text("sku").unique(),
...
export const fishfireOrders = pgTable("fishfire_orders", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  orderStatus: text("order_status").notNull().default("pending"), // "pending", "processing", "completed", "cancelled"
  paymentMethod: text("payment_method"), // "cash", "card", "online", "credit"
  notes: text("notes"),
...
export const fishfireOrderItems = pgTable("fishfire_order_items", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  orderId: varchar("order_id").references(() => fishfireOrders.id, { onDelete: "cascade" }).notNull(),
  productId: varchar("product_id").references(() => fishfireProducts.id, { onDelete: "restrict" }).notNull(),
...
// Business expenses
export const fishfireExpenses = pgTable("fishfire_expenses", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  expenseDate: timestamp("expense_date").notNull(),
  category: text("category").notNull(), // "supplies", "utilities", "rent", "marketing", "transportation", etc.
  description: text("description").notNull(),
  amount: decimal("amount", { precision: 10, scale: 2 }).notNull(),
  paymentMethod: text("payment_method").notNull(), // "cash", "bank", "card"
...
export const fishfirePurchases = pgTable("fishfire_purchases", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  totalAmount: decimal("total_amount", { precision: 10, scale: 2 }).notNull(),
  paymentStatus: text("payment_status").notNull().default("pending"), // "pending", "paid", "partial"
  paymentMethod: text("payment_method"), // "cash", "bank", "credit"
  deliveryDate: timestamp("delivery_date"),
  notes: text("notes"),
...
export const fishfirePurchaseItems = pgTable("fishfire_purchase_items", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  purchaseId: varchar("purchase_id").references(() => fishfirePurchases.id, { onDelete: "cascade" }).notNull(),
  productId: varchar("product_id").references(() => fishfireProducts.id, { onDelete: "restrict" }).notNull(),
  quantity: integer("quantity").notNull(),
...
export const fishfireDailyOrders = pgTable("fishfire_daily_orders", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  ...
  cardOrders: integer("card_orders").notNull().default(0),
  onlineOrders: integer("online_orders").notNull().default(0),
  creditOrders: integer("credit_orders").notNull().default(0),
...
export const fishfireDailyExpenses = pgTable("fishfire_daily_expenses", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  date: timestamp("date").notNull().unique(),
  totalExpenses: decimal("total_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  totalTransactions: integer("total_transactions").notNull().default(0),
  cashExpenses: decimal("cash_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  bankExpenses: decimal("bank_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  cardExpenses: decimal("card_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  suppliesExpenses: decimal("supplies_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  utilitiesExpenses: decimal("utilities_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  rentExpenses: decimal("rent_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  marketingExpenses: decimal("marketing_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  transportationExpenses: decimal("transportation_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  otherExpenses: decimal("other_expenses", { precision: 10, scale: 2 }).notNull().default("0"),
  notes: text("notes"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});

// Insert schemas for Fishfire tables
export const insertFishfireProductSchema = createInsertSchema(fishfireProducts).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertFishfireOrderSchema = createInsertSchema(fishfireOrders).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
...
export const insertFishfireOrderItemSchema = createInsertSchema(fishfireOrderItems).omit({
  id: true,
  createdAt: true,
});

export const insertFishfireExpenseSchema = createInsertSchema(fishfireExpenses).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
...
export const insertFishfirePurchaseSchema = createInsertSchema(fishfirePurchases).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
...
export const insertFishfirePurchaseItemSchema = createInsertSchema(fishfirePurchaseItems).omit({
  id: true,
  createdAt: true,
});

export const insertFishfireDailyOrderSchema = createInsertSchema(fishfireDailyOrders).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
...
export const insertFishfireDailyExpenseSchema = createInsertSchema(fishfireDailyExpenses).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
